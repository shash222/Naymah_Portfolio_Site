...
window.onscroll=function(){
	...
	function innerHTML(){
		document.getElementById("objective").innerHTML="I am an Architecture graduate from NJIT with a passion for interior design, architecture, and urban design and also excel in multiple architecture softwares."
	}
}
